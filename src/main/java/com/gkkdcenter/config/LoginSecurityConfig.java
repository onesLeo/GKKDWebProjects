...
import com.gkkdcenter.repo.UserDataServiceImpl;
import com.gkkdcenter.repo.UsersRepository;
...
public class LoginSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		web.ignoring().antMatchers("/resources/**","/static/**","/webjars/**", "/images/**", "/css/**", "/js/**", "/fonts/**"); // #3
	}
